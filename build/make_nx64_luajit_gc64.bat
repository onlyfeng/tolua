...
set "LUAJIT_CFLAGS=-DLJ_TARGET_CONSOLE -DLUAJIT_USE_SYSMALLOC -DLUAJIT_DISABLE_JIT -DLUAJIT_DISABLE_FFI"
...
copy /Y buildnx64\libtolua.a plugin_luajit\Plugins\Switch\libtolua.a
